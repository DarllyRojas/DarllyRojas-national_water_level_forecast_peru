...
def home(request):
    ...
    # Load stations data (SENAMHI_Stations_RT_v2.json)
    stations_file = os.path.join(os.path.join(app.get_app_workspace().path), 'SENAMHI_Stations_RT_v2.json')
